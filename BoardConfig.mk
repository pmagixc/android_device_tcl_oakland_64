...
# Assert
TARGET_OTA_ASSERT_DEVICE := oakland_64
...
# Kernel
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,64N2 androidboot.tct.platform=MTK buildvariant=user JRD_VERSION_MARK_R7K2V0V0CX00
